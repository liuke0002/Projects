...
public class RadarScanView extends View
{
    ...
    public void scaning(boolean startScan) {
		if(startScan){
			handler.post(run);
		}else{
	...
	private void initPaint()
    {
        ...
        mPaintCircle.setAntiAlias(true);//鎶楅敮榻�
        mPaintCircle.setStyle(Paint.Style.STROKE);//璁剧疆瀹炲績
        mPaintCircle.setStrokeWidth(2);//鐢荤瑪瀹藉害
